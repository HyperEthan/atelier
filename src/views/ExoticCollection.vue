...
<template>
  <main class="images-page container">
    <h1 class="page-title">异域风情系列</h1>
    <p class="page-intro">
      浏览Éclat工作室的异域风情系列，捕捉每一个独特的美妆风格和文化。
    </p>

    <div class="area">
      <div class="title">异域风情</div>
      <el-collapse v-model="collapseValue">
        <el-collapse-item title="优秀案例集" name="1">
          <div class="imgur-grid">
            <div v-for="item in images.youxiuanli" :key="item.id" class="grid-item" @click="openImageDialog(item)">
        ...
        <el-collapse-item title="灵感美图赏析" name="2">
          <div class="imgur-grid">
            <div v-for="item in images.linggan" :key="item.id" class="grid-item" @click="openImageDialog(item)">
              <div class="grid-item-content">
                <img :src="item.image" class="grid-item-thumbnail" />
                <div class="grid-item-overlay">
                  <el-button type="primary" size="small" :icon="IconPicture" circle />

...
import {
  Document, Notebook, Ship, Files, Connection // 常用图标
...
const marketingTools = ref([
  {
    ...
    name: '大赛文件',
    icon: markRaw(Document), // Element Plus Icon
    description: '汇总各类竞赛的通知、规则、任务书及相关资料，供备赛参考与使用。',
  },
  {
    id: 'Loose-leaf textbooks',
    name: '活页教材',
    icon: markRaw(Notebook),
    description: '提供配套学习资料，内容灵活、便于拆分使用，辅助教学与自主学习。',
  },
  {
    id: 'Examination question bank',
    name: '考证题库',
    icon: markRaw(Files),
    description: '收录各类职业资格考试的精选题目，助力高效备考与能力提升。'
  },
  {
    id: 'Career Handbook',
    name: '职业手册',
    icon: markRaw(Ship),
    description: '介绍岗位职责、职业规范与发展路径，助力职业认知与规划。',
  }
]);

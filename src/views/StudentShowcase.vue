...
const placeholderImages = [
  'https://via.placeholder.com/400x300/FF5733/FFFFFF?text=作品A',
  'https://via.placeholder.com/400x300/33FF57/FFFFFF?text=作品B',
  'https://via.placeholder.com/400x300/3357FF/FFFFFF?text=作品C',
  'https://via.placeholder.com/400x300/FF33E0/FFFFFF?text=作品D',
  'https://via.placeholder.com/400x300/33FFF2/FFFFFF?text=作品E',
  'https://via.placeholder.com/400x300/FFD700/000000?text=作品F',
  'https://via.placeholder.com/400x300/8A2BE2/FFFFFF?text=作品G',
  'https://via.placeholder.com/400x300/00FFFF/000000?text=作品H',
  'https://via.placeholder.com/400x300/DA70D6/FFFFFF?text=作品I',
  'https://via.placeholder.com/400x300/ADFF2F/000000?text=作品J',
];

// 添加一个随机作品到列表
function addRandomWork(showNotification = true) {
...
onMounted(() => {
    // 初始化加载一些作品
    const initialWorksCount = 10;
    for (let i = 0; i < initialWorksCount; i++) {
    addRandomWork(false); // 初始加载时不显示通知
    }
  uploadInterval = setInterval(() => {
    addRandomWork(true); // 每次模拟上传时显示通知
  }, uploadFrequency);
});
...
// watch studentWorks 变化，更新 previewSrcList
watch(studentWorks, (newWorks) => {
  previewSrcList.value = newWorks.map(work => work.src);
  ...
  <div class="student-showcase-container">
    ...
    <el-row :gutter="30" class="works-grid">
      <el-col
        ...
        class="work-col"
      >
        <el-card :body-style="{ padding: '0px' }" class="work-card" :class="{ 'is-new-work': work.isNew }">
